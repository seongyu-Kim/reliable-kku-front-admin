            ...
            <Modal animationType="slide" transparent={true} visible={isPlusMenuModal}>
                <styles.PlusMenuView>
                    <styles.CloseButtonImg onPress={handlePlusModal}>
                        <CloseButton height={heightPercentage(29)} width={widthPercentage(29)}/>
                    ...
                    <styles.HrLine/>
                    <Margin height={heightPercentage(128)}/>
                    ...
                    <Margin height={heightPercentage(22)}/>
                    ...
                    <Margin height={heightPercentage(23)}/>
                    ...
                    <styles.MenuImageView>
                        ...
                        <styles.PlusImage onPress={openModal}>
                            <PlusImg2 width={widthPercentage(24)} height={heightPercentage(24)}/>
                        </styles.PlusImage>
                    </styles.MenuImageView>

                    <Margin height={heightPercentage(105.55)}/>
                    ...
                    <Modal
                        ...
                        <styles.ImgModalView>
                            <styles.ImgModalBox>
                                <styles.CloseButtonImg2 hitSlop={{
                                    top: heightPercentage(30),
                                    bottom: heightPercentage(30),
                                    left: widthPercentage(30),
                                    right: widthPercentage(30)
                                }} onPress={closeModal}>
                                    <CloseButton height={heightPercentage(30)} width={widthPercentage(30)}/>
                                </styles.CloseButtonImg2>
                                <styles.ImgIconView>
                                    <styles.Icon onPress={handleCameraPress}>
                                        <CameraIcon height={heightPercentage(38.924)} width={widthPercentage(38.924)}/>
                                    </styles.Icon>
                                    <styles.Icon onPress={handleImagePress}>
                                        <ImageIcon height={heightPercentage(38.924)} width={widthPercentage(38.924)}/>
                                    </styles.Icon>
                                </styles.ImgIconView>
                            </styles.ImgModalBox>
                        </styles.ImgModalView>
