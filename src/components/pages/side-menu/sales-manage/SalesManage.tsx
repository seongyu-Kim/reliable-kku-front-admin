...
const SalesManage: React.FC = () => {
  ...
  const [isCalendarVisible, setCalendarVisivble] = useState(false);
  ...
  const [graph, setGraph] = useState<[{eachTime: string; totalPrice: number}]>(
    [],
  );
  ...
  const handleOpenCalendar = () => {
    setCalendarVisivble(true);
  };

  const handleCloseCalendar = () => {
    setCalendarVisivble(false);
  };
