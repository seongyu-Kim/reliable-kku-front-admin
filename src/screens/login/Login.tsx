...
import {heightPercentage, widthPercentage,} from '../../components/common/ResponsiveSize';
...
const Login: React.FC<{}> = () => {
    ...
    return (
        <styles.Container>
            <Margin width={0} height={heightPercentage(275)}/>
            ...
            <Margin width={0} height={heightPercentage(13)}/>
            ...
            <Margin width={0} height={heightPercentage(39)}/>
            ...
            <Margin width={0} height={heightPercentage(28)}/>
